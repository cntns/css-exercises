...
Yes,the elements containing "This should be styled" have the correct styles applied
- Do the elements that contain the text "This should be unstyled" have no styles applied?
Yes,the elements containing "This should be unstyled" have no styles applied
